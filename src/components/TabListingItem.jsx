...
const TabListingItem = ({name, address, price, imagePath}) => {
    

  return (
    <div className='bg-white shadow-md overflow-hidden rounded-lg w-[80%] border h-[7rem]'>
        <div className='flex p-3'>
            <img src={imagePath} alt='listing cover' className='h-[5rem] w-[8rem]  object-cover rounded-lg'/>
